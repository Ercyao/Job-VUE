...
var MonthText=new Array("","1月","2月","3月","4月","5月","6月","7月","8月","9月","10月","11月","12月");
...
'a:hover{padding-top:1px;border: 1px solid lightcoral;background:#FFF;border-radius: 50%;}'+
'.CurrentDate {height: 26px;padding-top: 1px;color:#fff!important;background: lightcoral;border-radius: 50%;}'+
...
'#Tools {width:204px;background:darkcyan;padding:0px;}'+
'#Tools li{padding-bottom:1px;}'+
'#Tools a{color:#FFF;}'+
'#Tools a:hover{border:1px solid #09fae9;background:#15f9e9;}'+
'#Title {width:204px;padding: 3px 0;}'+
'#Title li{height:16px;padding-top:3px;}'+
'#Day li a{color:#888;height: 26px;}'+
'#Day li{width: 28px;height: 28px;line-height:28px}'+
'#sYear,#sMonth {width:44px;height:16px;border-right:0;padding-top:2px;}'+
'#SArr {width:19px;height:18px;line-height: 18px;font-size:10px;text-align:center;color:#888;border-left:0;margin-right:3px;cursor:pointer;}'+
...
'ipt><div style="border:1px solid #dcdcdc;height:'+(110+21*Trn)+'px;"><ul><li style="background:#FFF;"></li>'+
...
'</ul></div>'+
'<div id="Title"><ul><li>日</li><li>一</li><li>二</li><li>三</li><li>四</li><li>五</li><li>六</li></ul></div>'+
'<ul id="Day" onClick="javascript:Calendar_GetDate('+year+','+month+',-1);">';
var date=null;
...
Calendar.style.height=114+21*Trn+'px';		//框架高度
